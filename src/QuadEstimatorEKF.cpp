...
void QuadEstimatorEKF::UpdateFromIMU(V3F accel, V3F gyro)
{
  ...
  ////////////////////////////// BEGIN STUDENT CODE ///////////////////////////
  Quaternion<float> predicted_attitude = Quaternion<float>::FromEuler123_RPY(rollEst, pitchEst, ekfState(6));  
  predicted_attitude.IntegrateBodyRate(gyro, dtIMU);
  ekfState(6) = predicted_attitude.Yaw();
  ...
  rollEst = attitudeTau / (attitudeTau + dtIMU) * (predicted_attitude.Roll()) + dtIMU / (attitudeTau + dtIMU) * accelRoll;
  pitchEst = attitudeTau / (attitudeTau + dtIMU) * (predicted_attitude.Pitch()) + dtIMU / (attitudeTau + dtIMU) * accelPitch;
